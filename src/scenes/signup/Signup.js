    ...
    const navigate=useNavigate()
     ...
     function signup(email, password,myName,mySurname) {
        const auth = getAuth();
           ...
           function create() {
              Axios.post('https://traveladvisor.herokuapp.com/api/auth/adminsignup',{
                name: myName,
                surname: mySurname,
                email:email,
                password:password,
  ...
  return (
    ...
    <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid
          ...
          md={7}
          sx={{
            backgroundImage: 'url(https://img.freepik.com/free-vector/flat-travel-background_23-2148043314.jpg?w=2000)',
