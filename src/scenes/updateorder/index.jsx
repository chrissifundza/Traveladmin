...
function Update(){
  ...
  setLoading(true)
axios.put('http://localhost:3001/orderupdate',{Status:Status,DriverName:SelectD[0].DriverName,DriverCell:SelectD[0].Cellphone,id:location.state.row.idorders}).then((response)=>{
  setLoading(false)  
